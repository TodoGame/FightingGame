...
export async function makeWebSocketConnection(config: WsConfig, user: UserData, additionalParams = ''): Promise<WebSocket> {
    ...
    return new WebSocket(`${wsUrl}${additionalParams}`)
}
